...
/**
 * @brief Represents the groupId that was used to initialize this cloud recognition service and should correspond to the one that is associated with your Wikitude cloud recognition account.
 *
 * @discussion In case the cloud recognition service was created with an API that did not specify a group id explicitly, this method returns an empty string
 */
